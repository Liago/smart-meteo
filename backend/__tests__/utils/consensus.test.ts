 ...
 *
 * Portato da `scripts/verifyConsensus.ts` alla suite Jest nella Fase 6B: due sistemi di test
...
describe('consensus — accordo fra le fonti', () => {
		...
		it('dispersione nulla su valori identici', () => {
		...
		it('min e max sono gli estremi osservati, non la media', () => {
		const spread = weightedSpread([
			{ val: 18, weight: 1 },
			{ val: 21, weight: 1 },
			{ val: 24, weight: 1 },
		...
		it('il peso della fonte sposta la dispersione', () => {
		...
		it('pesi e valori non validi ignorati', () => {
		...
		it('unanimità su molte fonti → punteggio alto', () => {
		...
		it('disaccordo pieno su molte fonti → punteggio basso', () => {
		const temps = [
			{ val: 12, weight: 1 },
			{ val: 18, weight: 1 },
			{ val: 24, weight: 1 },
		...
		it('una sola fonte non vale un consenso: contratto verso 50', () => {
		...
		it('a pari accordo, più fonti → punteggio più alto', () => {
		const mk = (n: number) => {
		...
		it('dispersione oltre la soglia → contributo azzerato, non negativo', () => {
		...
		it('se manca la pioggia, la temperatura si prende tutto il peso', () => {
		...
		it('la soglia pioggia è in punti percentuali, non in frazione', () => {
		...
		it('punteggio sempre nell intervallo 0-100', () => {
		const casi = [
